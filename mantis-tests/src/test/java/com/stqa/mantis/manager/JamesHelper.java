...
public class JamesHelper {
  ...
  public void createUser(String name, String password) {
    ...
    String result = readUntill("User " + name + " added");
    closeTelnetSession();
  }
  ...
  public boolean doesUserExist(String name) {
    initTelnetSession();
    write("verify " + name);
    String result = readUntill("exist");
    closeTelnetSession();
  ...
  public void deleteUser(String name, String password) {
    ...
    String result = readUntill("User " + name + " deleted");
    closeTelnetSession();
  }
  ...
  public void initTelnetSession() {
    ...
    readUntill("Welcome " + login + ". HELP for a list of commands");

  }

  private String readUntill(String pattern) {
    try {
